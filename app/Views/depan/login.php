      ...
      <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
        <div class="card col-lg-4 mx-auto">
          <div class="card-body px-5 py-5">
            <h1 class="card-title text-center ">Login Wali Murid</h1>
            <p class="card-title text-center mb-5">dengan era digital untuk masa depan yang baik</p>
            <form method="POST" action="<?= base_url('/actionwalimurid') ?>">
              <div class="form-group">
                <label>Username</label>
                <input type="text" name="nis_siswa" placeholder="Masukan NIS Siswa" class="form-control p_input text-light">
              </div>
              <div class="form-group">
                <label>Password</label>
                <input type="password" name="pass_siswa" placeholder="Masukan password Siswa" class="form-control p_input text-light">
              </div>
              <div class="text-left">
