      ...
      <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
        <div class="card col-lg-4 mx-auto">
          <div class="card-body px-5 py-5">
            <h1 class="card-title text-center ">Maaf Saldo Anda <strong class="text-primary">Tidak Mencukupi</strong></h1>
            <p class="card-title text-center mb-5">dengan era digital untuk masa depan yang baik</p>
            <form>

              <div class="text-center">
                <a class="btn btn-primary btn-block enter-btn" href="<?= base_url('logout'); ?>">Keluar</a>
              </div>
